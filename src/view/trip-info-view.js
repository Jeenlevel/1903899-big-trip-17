...
const getTripDates = (waypoints) => `${dayjs(waypoints[0].dateFrom).format(DateFormat.DAY_MONTH)}&nbsp;&mdash;&nbsp${dayjs(waypoints[waypoints.length - 1].dateTo).format(DateFormat.DAY_MONTH)}`;
