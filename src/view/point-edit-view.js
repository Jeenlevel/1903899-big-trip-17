...
import he from 'he';
import { humanizeDateToCustomFormat } from '../utils/point.js';
import { DateFormat, DEFAULT_TIME } from '../consts.js';
...
const createPointEditTemplate = (state, offersData, destinationsData) => {
...
export default class PointEditView extends AbstractStatefulView {
  ...
  constructor(waypoint, offersData, destinationsData) {
    super();
    this._state = PointEditView.parseWaypointToState(waypoint);
  ...
  get template() {
    return createPointEditTemplate(this._state, this.#offersData, this.#destinationsData);
  }
  ...
  reset = (waypoint) => {
    this.updateElement(PointEditView.parseWaypointToState(waypoint));
  };
  ...
  #formSubmitHandler = (evt) => {
    evt.preventDefault();
    this._callback.formSubmit(PointEditView.parseStateToWaypoint(this._state));
  };
  ...
  #formDeleteClickHandler = (evt) => {
    evt.preventDefault();
    this._callback.deleteClick(PointEditView.parseStateToWaypoint(this._state));
  };
  ...
  #setDatepicker = () => {
    ...
    this._dateFromPicker = flatpickr(
      this.element.querySelector('#event-start-time-1'),
      {
        ...
        defaultDate: dayjs(this._state.dateFrom).format(DateFormat.DAY_MONTH_YEAR_HOUR_MIN),
    ...
    this._dateToPicker = flatpickr(
      this.element.querySelector('#event-end-time-1'),
      {
        enableTime: true,
        dateFormat: DateFormat.FLATPICKR,
        minDate: dayjs(this._state.dateFrom).format(DateFormat.DAY_MONTH_YEAR_HOUR_MIN),
        defaultDate: dayjs(this._state.dateTo).format(DateFormat.DAY_MONTH_YEAR_HOUR_MIN),
  ...
  #dateFromChangeHandler = ([userDate]) => {
    ...
    this.updateElement({
      dateFrom: dayjs(userDate).format(DateFormat.YEAR_MONTH_DAY_HOUR_MIN),
  ...
  #dateToChangeHandler = ([userDate]) => {
    this.updateElement({
      ...
      dateTo: dayjs(userDate).format(DateFormat.YEAR_MONTH_DAY_HOUR_MIN),
    });
  };
